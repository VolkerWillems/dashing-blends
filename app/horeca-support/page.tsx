  ...
  return (
    <main className="overflow-hidden">
      ...
      <PageHero
        ...
        image="/duane-01.webp"
        imageAlt="Dashing Blends ondersteunt een horecateam achter de bar"
      ...
      <section className="soft-section border-y border-border/70 py-24 sm:py-32">
        <div className="section-shell grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          ...
          <div className="fade-up grid gap-6 sm:grid-cols-3">
            <div className="subtle-panel border border-border p-7">
      ...
      <section className="soft-section border-y border-border/70 py-24 sm:py-32">
        <div className="section-shell grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          <div className="fade-up subtle-panel border border-border p-8 sm:p-12">
